...
public class VeriSetleri {
    ...
    static {
        try {
            ...
            if (is == null) {
                throw new RuntimeException("il-ilce.json bulunamad�!");
            }
        ...
        try {
            ...
            if (is == null) {
                throw new RuntimeException("soyad.json bulunamad�!");
            }
            String jsonTxt = new String(is.readAllBytes(), StandardCharsets.UTF_8);
            JSONArray arr = new JSONArray(jsonTxt);
            for (int i = 0; i < arr.length(); i++) {
        ...
        try {
            ...
            if (is == null) {
                throw new RuntimeException("sirketAdi.json bulunamad�!");
            }
            String jsonTxt = new String(is.readAllBytes(), StandardCharsets.UTF_8);
            JSONArray arr = new JSONArray(jsonTxt);
            for (int i = 0; i < arr.length(); i++) {
        ...
        try {
            ...
            if (is == null) {
                throw new RuntimeException("adres.json bulunamad�!");
            }
            String jsonTxt = new String(is.readAllBytes(), StandardCharsets.UTF_8);
            JSONArray arr = new JSONArray(jsonTxt);
            for (int i = 0; i < arr.length(); i++) {
        ...
        try {
            ...
            if (is == null) {
                throw new RuntimeException("ulkeler.json bulunamad�!");
            }
            String jsonTxt = new String(is.readAllBytes(), StandardCharsets.UTF_8);
            JSONArray arr = new JSONArray(jsonTxt);
            for (int i = 0; i < arr.length(); i++) {
                ULKELER.add(arr.getString(i));
            }
        } catch (IOException | RuntimeException e) {
            System.err.println("Hata: " + e.getMessage());
        }
        ...
        try {
            ...
            if (is == null) {
                throw new RuntimeException("uyruk.json bulunamad�!");
            }
            String jsonTxt = new String(is.readAllBytes(), StandardCharsets.UTF_8);
            JSONArray arr = new JSONArray(jsonTxt);
            for (int i = 0; i < arr.length(); i++) {
        ...
        try {
            ...
            if (is == null) {
                throw new RuntimeException("unvan.json bulunamad�!");
            }
            String jsonTxt = new String(is.readAllBytes(), StandardCharsets.UTF_8);
            JSONArray arr = new JSONArray(jsonTxt);
            for (int i = 0; i < arr.length(); i++) {
